...
parser.add_argument('--path_to_txt', type=str,default='/content/DomainToText_AMLProject/data/PACS', help='path to the txt files')
parser.add_argument('--path_to_dataset', type=str, default='/content/DomainToText_AMLProject/',help='path to the dataset')
